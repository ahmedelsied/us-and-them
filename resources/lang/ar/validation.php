...
return [
    ...
    'attributes'           => [
        ...
        'content.en' => 'المحتوى بالانجليزية',
        ...
        'text.en' => 'النص بالانجليزية',
        'text.ar' => 'النص بالعربية',
        'course_id' => 'الدورة',
        'slider_image' => 'صورة السلايدر',
        'body.en' => 'المحتوى بالانجليزية',
        'body.ar' => 'المحتوى بالعربية',
        'subtitle.en' => 'النص الفرعي بالانجليزية',
        'subtitle.ar' => 'النص الفرعي بالعربية',
        'year' => 'السنة',
        'author.en' => 'المؤلف بالانجليزية',
        'author.ar' => 'المؤلف بالعربية',
        'teacher.en' => 'المدرس بالانجليزية',
        'teacher.ar' => 'المدرس بالعربية',
        'teacher_description.en' => 'وصف المدرس بالانجليزية',
        'teacher_description.ar' => 'وصف المدرس بالعربية',
        'status' => 'الحالة',
        'vimeo_id' => 'رقم تعريف فيميو',
        'active' => 'نشط',
        'is_trailer' => 'هل هو إعلان',
        'is_sample' => 'هل هو عينة',
        'highlighted' => 'تحت الأضواء',
        'cover' => 'الغلاف',
